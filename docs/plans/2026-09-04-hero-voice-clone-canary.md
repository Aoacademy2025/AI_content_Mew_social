...
- [ ] Build/publish `ghcr.io/mewic/heroai-omnivoice-clone:<git-sha>`, capture its OCI digest/SBOM/manifests, and reference the candidate template by digest only. No mutable tag may be used for execution.
  - Build/publish and capture are complete for commit `3ae5658f`: OCI index `sha256:dcbc9d852fed7798bef4081def51e09ab3e483f71416d756c42a59303614a40d`, Linux/amd64 manifest `sha256:2137e25614548f3f1a31405ca9f48b277775dd76f41c5fc8c0d4b49a1df23a6c`, digest-bound SPDX/SLSA attestations, and full authenticated OCI scan all passed. This item stays unchecked until a dedicated candidate template is created and read back using the immutable digest.
...
- Work only in Orca worktree branch `mewic/hero-voice-clone-prod-audit`; preserve unrelated user work. A PR may be opened, but this plan never merges or deploys production.
