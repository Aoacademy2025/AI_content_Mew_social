# Task 2 fix round 1 package

Base: 92bddd8d
Head: 311c7558
Report: task-2-fix-1.md
```
311c7558 fix(hero-script): keep historical library filters
```
```
 .../hero-script-workspace-ux/task-2-fix-1.md       |  24 +++
 scripts/verify-hero-script-library.ts              | 176 ++++++++++++++++++++-
 .../hero-script/_components/ScriptHistory.tsx      |  40 ++---
 src/lib/hero-script-library.server.ts              |  17 +-
