...
Base: 311c7558
Head: b1da15f0
Report: task-1-fix-2.md
```
b1da15f0 fix(hero-script): invalidate stale hooks
```
```
 .../hero-script-workspace-ux/task-1-fix-2.md       | 11 +++++
 scripts/verify-hero-script-workspace-browser.mts   | 47 +++++++++++++++++++---
 .../hero-script/_components/BrandProfilePanel.tsx  |  4 ++
 .../hero-script/_components/TopicStep.tsx          |  2 +-
 src/app/(dashboard)/hero-script/page.tsx           |  8 +++-
