...
| AC7 | open-existing zero POST, save-before-create, one pending request, failure blocks handoff | PASS — mounted request ledger covers each boundary; `verify:hero-script` passes. |
