...
- Tasks 1–9 + 6b (CI harness registration) merged into `mew/brands-wave1`; every task passed a Tier-1 review (spec + quality) and, where needed, one scoped fix round. Ledger with all controller rulings R1–R29: `.superpowers/sdd/2026-09-02-brands-wave1-style-packs/progress.md` (git-ignored; summarised in the PR body).
