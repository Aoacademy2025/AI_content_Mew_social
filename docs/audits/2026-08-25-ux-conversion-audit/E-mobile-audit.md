...
| iPhone Safari จริง — Gallery | 🔴 **แตะการ์ดกลางจอ = เริ่มดาวน์โหลดไฟล์ 102 MB ทันที ไม่ได้ดูคลิป** (ปุ่มดาวน์โหลด hover-only อยู่ตรงกลางการ์ด, ปุ่มลบอยู่ข้างๆ) → #328 ยกเป็น P0 |
