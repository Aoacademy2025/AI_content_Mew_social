...
export const meta: DocMeta = {
  ...
  keywords: [
    ...
    "cta", "เขียนใหม่", "ส่งไปตัดต่อ", "subscription", "ชำระเงิน", "คูปอง",
  ],
  ...
  return (
    <div className="space-y-5">
      ...
      <Section title="สิทธิ์ใช้งานและการชำระเงิน" icon={<BadgeCheck className="h-4 w-4 text-violet-300" strokeWidth={2.25} />}>
        <p>
          สมาชิกแบบชำระเงิน หรือสมาชิกที่ได้รับ PRO/BUSINESS จากคูปองแบบให้สิทธิ์ซึ่งยังไม่หมดอายุ
          จะได้รับสิทธิ์ Hero Script เต็มรูปแบบ
          ส่วนบัญชีที่กำลังทยอยเปิดใช้งานจะเห็นหน้า Preview และรายละเอียดแพ็กเกจก่อน
        </p>
        <Callout kind="warn">
          หากชำระเงินหรือกรอกคูปองสำเร็จแล้วแต่ยังเห็น Preview ให้รีเฟรชหนึ่งครั้งหรือออกแล้วเข้าใหม่
          ถ้ายังไม่เปิดภายใน 5 นาที ให้ส่ง ticket พร้อมอีเมลบัญชีและเวลาที่ทำรายการ โดยไม่ต้องส่งเลขบัตร คูปอง หรือข้อมูลลับ
        </Callout>
      </Section>
