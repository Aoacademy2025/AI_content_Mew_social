...
const DEFAULTS = {
  free_price: "0",
  free_features: "ทดลอง PRO ฟรี 7 วัน|หลังหมดทดลอง: 2 คลิป/เดือน|ความยาววิดีโอสูงสุด 2 นาทีต่อคลิป|จัดเก็บวิดีโอบนระบบนาน 3 วัน|สร้างคอนเทนต์ด้วย AI (จำกัด 5 ชิ้น)|ใช้ Gemini API key ของตัวเอง|Font พื้นฐานเท่านั้น",
  pro_price: "599",
