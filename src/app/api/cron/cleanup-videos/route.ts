...
// Called by a cron job (or Vercel Cron) every day for non-customer-media chores.
...
export async function GET(req: Request) {
  ...
  // Customer media is intentionally not deleted here. The media reference graph and
  // quarantine workflow are the only automatic lifecycle owner; keep videosDeleted in
  // the response for compatibility with the existing cron monitor.
