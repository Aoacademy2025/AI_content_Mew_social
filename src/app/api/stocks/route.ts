...
/**
 * DELETE /api/stocks — compatibility endpoint, intentionally fail-closed.
 * Completed stock media can be referenced by saved drafts or active renders;
 * lifecycle mutation therefore requires a reviewed graph/quarantine manifest.
 */
export async function DELETE() {
  ...
  return NextResponse.json({
    ...
    message: "Stock media cleanup requires a reviewed graph/quarantine manifest.",
  }, { status: 409 });
}
