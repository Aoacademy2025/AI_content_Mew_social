...
export function BrandVisualSelector({
  ...
  const canRenderPersistedVisual = p.brandVisualAllowed || p.hasPersistedVisualPin;
  ...
  async function loadLibrary(signal?: AbortSignal) {
    if (!p.brandVisualAllowed) return;
  ...
  }, [p.brandVisualAllowed]); // eslint-disable-line react-hooks/exhaustive-deps
