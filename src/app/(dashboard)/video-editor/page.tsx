...
export default function VideoEditorPage() {
  ...
  async function runAvatarPipeline() {
    ...
    try {
      ...
      // Always re-generate avatar (don't reuse cached avatarGreenUrl) so changing
      // the avatar ID actually takes effect.
      setAvatarGreenUrl("");
      const avUrl = await runAvatar(audioUrl);
    ...
    <div className={cn(
      ...
      <div className="relative z-10 flex flex-1 overflow-hidden">
        ...
        <div ref={centerPanelRef} className="flex-1 flex flex-col bg-[#0c0c0f]/80 min-w-0">
          ...
          <div className="relative isolate h-12 bg-[#111115] border-t border-[#1e1e28] flex flex-nowrap items-center gap-2 px-4 flex-shrink-0 min-w-0 overflow-x-clip overflow-y-visible">
            {/* Skip back */}
