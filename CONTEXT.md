...
- **Brand Visual Language** — the recurring visual grammar of a Brand Profile, such as its character system, linework, shapes, palette, iconography and composition patterns. It is the visual component of Brand DNA, not a video's topic or temporary mood.
- **Visual Brand Brief** — the creator's structured input for shaping a Brand Visual Language: its primary look, palette, personality, people or setting context, and optional memorable visual cues.
...
- **Text-free AI Image / ภาพไม่มีตัวอักษร** — an AI-generated visual that contains no model-rendered words, captions, labels, logos or watermarks. In V1, the deterministic subtitle and brand-mark layers own all readable text so visual generation remains independent of a model's language-rendering ability.
