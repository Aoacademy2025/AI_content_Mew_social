...
- **Paid-Equivalent Entitlement** — an active PRO or BUSINESS entitlement backed by either a successful plan payment, an active paid Bundle, an active GRANT coupon issued for a paid course or program, or an explicit Administrator Grant. These sources receive the same product capabilities within the granted plan's normal quotas and expiry while preserving their distinct commercial origin; FREE and TRIAL status alone never qualifies.
