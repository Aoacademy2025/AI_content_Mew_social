  ...
  try {
    ...
    await prisma.videoJob.create({
      data: {
        ...
        currentStep: "avatar",
        progress: 100,
        inputJson: JSON.stringify({ avatarId: "avatar-legacy", script: "ทดสอบ legacy recovery", previewMode: true, avatarMode: "full", voiceProvider: "gemini", avatarIntroSecs: 5, avatarTailSecs: 5, avatarScale: 1.25, avatarOffsetX: 0, avatarOffsetY: 0 }),
    ...
    await prisma.videoJob.create({
      data: {
        ...
        status: "done",
        inputJson: JSON.stringify({ ...input, avatarScale: 1.5 }),
