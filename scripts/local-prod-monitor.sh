...
import json,sys
CRON={\"trial-expiry\",\"founding-sweep\",\"renewal-reminders\",\"cleanup-videos\",\"reconcile-processing\",\"reconcile-ai-images\",\"mine-loanwords\",\"disk-watch\",\"db-backup\",\"media-cleanup\",\"runpod-image-cost-sync\",\"north-star-snapshot\"}
